...
HWND hRed,hGreen,hBlue, hSBlue;
int Red,Green,Blue;  
//COLORREF iCurrentColor=RGB(255,0,0);
// p.159 го╢э red=GetRValue(iCurrentColor);
LRESULT CALLBACK WndProc(HWND hWnd,UINT iMessage,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		hSBlue=CreateWindow(TEXT("static"),TEXT(""),WS_CHILD | WS_VISIBLE,
			420,70,100,25,hWnd,(HMENU)-1,g_hInst,NULL);
